 ...
 */
public class CocoAnnotationViewerApp extends Application {
        ...
        borderPane.addEventHandler(DragEvent.DRAG_DROPPED, event -> {
            ...
            if (db.hasFiles()) {
                ...
                try {
                    ...
                    Logger.getLogger(CocoAnnotationViewerApp.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
...
//                transformOverlays();
        ...
        stage.setTitle("COCO Annotation Viewer");
